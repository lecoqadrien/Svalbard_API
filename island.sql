...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 27 juin 2019 à 09:47
...
(4, 'Quelles sont les animaux le plus toucher par les courant chaud à Svalbard?', 4, 'Les rennes', 'Les souris', 'Les renards', 'Les licornes', 'Oui'),
...
(6, 'Que risque Svalbard dans 50 ans?', 6, 'Un tremblement de terre', 'L arrivée des Indiens', 'Prendre entre 7 et 10 degrés de plus', 'La fin du monde', 'Oui'),
